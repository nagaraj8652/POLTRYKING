...
@Component({
  selector: 'app-viewer-model',
  templateUrl: './viewer-model.component.html',
  styleUrls: ['./viewer-model.component.scss'],
})



export class ViewerModelComponent implements OnInit {
